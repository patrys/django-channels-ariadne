...
def create_graphql_consumer(
    ...
    class GraphQLConsumer(AsyncHttpConsumer):
        ...
        async def handle_graphql_error(self, error: GraphQLError) -> List[bytes]:
        ...
        async def handle_http_error(self, error: HttpError) -> List[bytes]:
        ...
        async def handle_request(self, body: bytes) -> List[bytes]:
        ...
        async def handle_get(self) -> List[bytes]:
            await self.send_response(
                200,
        ...
        async def handle_post(self, body: bytes) -> List[bytes]:
        ...
        async def return_response_from_result(
